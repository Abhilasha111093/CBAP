...
#P<0.05 yes the model exist atlst one independent variable that has got strong relationship
#Rsq=> 0.9042 90% of variation in  is explained by x(variables)--higher the values better it is 
#residual error: tells abouot linear model
